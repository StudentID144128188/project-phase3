    ...
    useEffect(() => {
      fetch(`http://localhost:8080/api/items/${id}`) // GET
        ...
        .then((json) => {
          ...
          setPrice(json.price);
          setLatitude(json.coord[0]);
          setLongitude(json.coord[1]);
          setStar(json.star);
          setImage1(json.image[0]);
          setImage2(json.image[1]);
          setImage3(json.image[2]);
          setType(json.type);
          setBestSeller(json.bestSeller);
          setFeatured(json.featured);
          setWifi(json.amenities.wifi);
          setParking(json.amenities.parking);
          setBathtub(json.amenities.bathtub);
          setRestaurant(json.amenities.restaurant);
          setBar(json.amenities.bar);
          setSpa(json.amenities.spa);
          setGym(json.amenities.gym);
          setPet(json.rules.pet);
          setSmoke(json.rules.smoke);
          setComment({
            convenient: json.comments.convenient,
            quiet: json.comments.quiet,
            walkable: json.comments.walkable,
            safe: json.comments.safe,
            transportation: json.comments.transportation,
            rating: json.comments.rating,
            total: json.comments.total,
          })
        })
      ...
      <>
        <Container>
          ...
          <Form className="create-item">
            <h3 className="login-header">Property Update</h3>
            <Row>
